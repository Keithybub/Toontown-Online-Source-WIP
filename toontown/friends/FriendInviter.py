...
class FriendInviter(DirectFrame):
    ...
    def __init__(self, avId, avName, avDisableName):
        ...
        DirectFrame.__init__(self, pos = (0.29999999999999999, 0.10000000000000001, 0.65000000000000002), image_color = GlobalDialogColor, image_scale = (1.0, 1.0, 0.59999999999999998), text = '', text_wordwrap = TTLocalizer.FIdirectFrameWordwrap, text_scale = TTLocalizer.FIdirectFrame, text_pos = TTLocalizer.FIdirectFramePos)
        ...
        self.bOk.hide()
        self.bCancel = DirectButton(self, image = (buttons.find('**/CloseBtn_UP'), buttons.find('**/CloseBtn_DN'), buttons.find('**/CloseBtn_Rllvr')), relief = None, text = OTPLocalizer.FriendInviterCancel, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), pos = TTLocalizer.FIbCancelPos, command = self._FriendInviter__handleCancel)
        self.bCancel.hide()
        ...
        self.bStop.hide()
        self.bYes = DirectButton(self, image = (buttons.find('**/ChtBx_OKBtn_UP'), buttons.find('**/ChtBx_OKBtn_DN'), buttons.find('**/ChtBx_OKBtn_Rllvr')), relief = None, text = OTPLocalizer.FriendInviterYes, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), pos = TTLocalizer.FIbYesPos, command = self._FriendInviter__handleYes)
        self.bYes.hide()
        ...
        self.bNo.hide()
        self.bToon = DirectButton(self, image = (buttons.find('**/ChtBx_OKBtn_UP'), buttons.find('**/ChtBx_OKBtn_DN'), buttons.find('**/ChtBx_OKBtn_Rllvr')), relief = None, text = TTLocalizer.FriendInviterToon, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), pos = (-0.34999999999999998, 0.0, -0.050000000000000003), command = self._FriendInviter__handleToon)
        toonText = DirectLabel(parent = self, relief = None, pos = Vec3(0.34999999999999998, 0, -0.20000000000000001), text = TTLocalizer.FriendInviterToonFriendInfo, text_fg = (0, 0, 0, 1), text_pos = (0, 0), text_scale = 0.044999999999999998, text_align = TextNode.ACenter)
        toonText.reparentTo(self.bToon.stateNodePath[2])
        self.bToon.hide()
        self.bPlayer = DirectButton(self, image = (buttons.find('**/ChtBx_OKBtn_UP'), buttons.find('**/ChtBx_OKBtn_DN'), buttons.find('**/ChtBx_OKBtn_Rllvr')), relief = None, text = TTLocalizer.FriendInviterPlayer, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), pos = (0.0, 0.0, -0.050000000000000003), command = self._FriendInviter__handlePlayer)
        playerText = DirectLabel(parent = self, relief = None, pos = Vec3(0, 0, -0.20000000000000001), text = TTLocalizer.FriendInviterPlayerFriendInfo, text_fg = (0, 0, 0, 1), text_pos = (0, 0), text_scale = 0.044999999999999998, text_align = TextNode.ACenter)
    ...
    def enterCheckAvailability(self):
        ...
        if self.playerFriend:
            ...
            self.accept(OTPGlobals.PlayerFriendRejectInviteEvent, self._FriendInviter__playerFriendRejectResponse)
            self.accept(OTPGlobals.PlayerFriendAddEvent, self._FriendInviter__playerFriendAcceptResponse)
            self.bOk.show()
        else:
