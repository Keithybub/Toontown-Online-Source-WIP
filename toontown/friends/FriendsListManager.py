...
class FriendsListManager:
    ...
    def load(self):
        ...
        self.accept(OTPGlobals.AvatarNewFriendAddEvent, self._FriendsListManager__friendAdded)
    ...
    def enterFLM(self):
        ...
        self.accept('clickedNametagPlayer', self._FriendsListManager__handleClickedNametagPlayer)
        ...
        self.accept('playerDetails', self._FriendsListManager__handlePlayerDetails)
        self.accept('friendInvitation', self._FriendsListManager__handleFriendInvitation)
        self.accept(OTPGlobals.PlayerFriendInvitationEvent, self._FriendsListManager__handlePlayerFriendInvitation)
    ...
    def _FriendsListManager__handleClickedNametagPlayer(self, avatar, playerId, showType = 1):
    ...
    def _FriendsListManager__handlePlayerFriendInvitation(self, avId, avName, inviterDna = None, context = None):
    ...
    def processQueuedRequests(self):
        if len(self.friendsRequestQueue):
            ...
            self._FriendsListManager__processFriendRequest(request[0], request[1], request[2], request[3])
        

    
    def _FriendsListManager__processFriendRequest(self, avId, avName, inviterDna = None, context = None):
    ...
    def _FriendsListManager__handlePlayerDetails(self, avId, avName, playerId = None):
