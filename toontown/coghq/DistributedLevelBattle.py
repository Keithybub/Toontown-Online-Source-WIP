...
class DistributedLevelBattle(DistributedBattle.DistributedBattle):
    ...
    def enterFaceOff(self, ts):
        ...
        self._DistributedLevelBattle__faceOff(ts, self.faceOffName, self._DistributedLevelBattle__handleFaceOffDone)
    ...
    def enterReward(self, ts):
        ...
        self.delayDeleteMembers()
        self._DistributedLevelBattle__playReward(ts, self._DistributedLevelBattle__handleFloorRewardDone)
