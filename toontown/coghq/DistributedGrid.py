...
class DistributedGrid(BasicEntities.DistributedNodePathEntity):
    ...
    def loadModel(self):
        ...
        self.model.setPos(self.cellSize * self.numCol / 2.0, self.cellSize * self.numRow / 2.0, 0.025000000000000001)
        self.model.setColor(0.58799999999999997, 0.58799999999999997, 0.45900000000000002, 0.40000000000000002)
