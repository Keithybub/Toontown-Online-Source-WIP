...
class GameSprite:
    ...
    def warningBump(self):
        ...
        track = Sequence(Wait(num1 * 0.10000000000000001), LerpPosInterval(self.nodeObj, num2 * 0.10000000000000001, Point3(0.0, 0.0, 0.5)), LerpPosInterval(self.nodeObj, num3 * 0.10000000000000001, Point3(0.0, 0.0, 0.0)), LerpPosInterval(self.nodeObj, num2 * 0.10000000000000001, Point3(0.0, 0.0, 0.5)), LerpPosInterval(self.nodeObj, num1 * 0.10000000000000001, Point3(0.0, 0.0, 0.0)))
        track.start()
    ...
    def shake(self):
        ...
        curr = self.nodeObj.getPos()
        dest = Point3(0 + curr[0], 0 + curr[1], 1.0 + curr[2])
        track = Sequence(LerpPosInterval(self.nodeObj, num2 * 0.10000000000000001, Point3(0.0, 0.0, 0.25)), LerpPosInterval(self.nodeObj, num1 * 0.10000000000000001, Point3(0.0, 0.0, 0.0)))
        track.start()
