...
class DistributedSecurityCamera(BasicEntities.DistributedNodePathEntity):
    ...
    def __init__(self, cr):
        ...
        self.attackTrack = Parallel(SoundInterval(self.attackSound, node = self, volume = 0.80000000000000004), SoundInterval(self.onSound, node = self, volume = 0.80000000000000004))
        self.moveStartSound = loader.loadSfx('phase_11/audio/sfx/LB_laser_beam_on_2.mp3')
        self.moveStartTrack = Parallel(SoundInterval(self.moveStartSound, node = self, volume = 0.40000000000000002))
        self.moveLoopSound = loader.loadSfx('phase_11/audio/sfx/LB_laser_beam_hum_2.mp3')
        self.moveLoopSound.setLoop()
        self.moveLoopTrack = Parallel(SoundInterval(self.moveLoopSound, node = self, volume = 0.40000000000000002))
        self.moveStopSound = loader.loadSfx('phase_11/audio/sfx/LB_laser_beam_off_2.mp3')
        self.moveStopTrack = Parallel(SoundInterval(self.moveStopSound, node = self, volume = 0.40000000000000002))
        self.taskName = None
    ...
    def _DistributedSecurityCamera__detect(self, task):
        ...
        taskMgr.doMethodLater(0.10000000000000001, self._DistributedSecurityCamera__detect, self.detectName)
        return Task.done
    ...
    def loadModel(self):
        ...
        taskMgr.add(self._DistributedSecurityCamera__updateTrack, self.taskName, priority = 25)
