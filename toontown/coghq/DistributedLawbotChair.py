...
class DistributedLawbotChair(DistributedObject.DistributedObject, FSM.FSM):
    ...
    def enterToonJuror(self):
        self.chair.setColorScale(0.20000000000000001, 0.20000000000000001, 1.0, 1.0)
    ...
    def enterOn(self):
        ...
        self.ival.loop()
        self.accept('enterChairZap', self._DistributedLawbotChair__touchedChair)
        self.accept('enterChairHandleZap', self._DistributedLawbotChair__touchedChairHandle)
