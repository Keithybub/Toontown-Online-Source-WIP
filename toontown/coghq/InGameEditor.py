...
class InGameEditor(AppShell):
    ...
    def addVec3Widget(self, levelSpec, entSpec, entId, attribName, params, datatype):
        ...
        widg._floaters.component('valuatorGroup')['postCallback'] = lambda x, y, z: veCommand([
x,
y,
z])
        self.attribWidgets.append(widg)
    ...
    def addColorWidget(self, levelSpec, entSpec, entId, attribName, params):
        ...
        widg._floaters.component('valuatorGroup')['postCallback'] = lambda x, y, z, a: veCommand([
x,
y,
z,
a])
    ...
    def addFileWidget(self, levelSpec, entSpec, entId, attribName, params):
        ...
        def askFilename(callback = handleReturn):
            ...
            rawFilename = askopenfilename(defaultextension = '*', initialdir = initialDir, filetypes = (('Bam Files', '*.bam'), ('Egg Files', '*.egg'), ('Maya Binaries', '*.mb'), ('All files', '*')), title = 'Load Model File', parent = self.interior())
            if rawFilename != '':
    ...
    def handleSaveAs(self):
        filename = tkFileDialog.asksaveasfilename(parent = self.parent, defaultextension = '.py', filetypes = [
