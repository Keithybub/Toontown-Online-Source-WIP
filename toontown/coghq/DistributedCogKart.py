...
class DistributedCogKart(DistributedElevatorExt.DistributedElevatorExt):
    ...
    JumpOutOffsets = ((6.5, -2, -0.025000000000000001), (-6.5, -2, -0.025000000000000001), (3.75, 5, -0.025000000000000001), (-3.75, 5, -0.025000000000000001))
    ...
    def announceGenerate(self):
        ...
        wheelAngle = (dist / 4.7999999999999998 * 1.3999999999999999 * math.pi) * 360
