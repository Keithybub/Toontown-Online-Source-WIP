...
class DistributedStage(DistributedObject.DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self.titleText = OnscreenText.OnscreenText('', fg = self.titleColor, shadow = (0, 0, 0, 1), font = ToontownGlobals.getSuitFont(), pos = (0, -0.5), scale = 0.10000000000000001, drawOrder = 0, mayChange = 1)
    ...
    def setRoomDoIds(self, roomDoIds):
        ...
        self.roomWatcher = [](_[1], [ DistributedStageRoom.getStageRoomReadyPostName(doId) for doId in self.roomDoIds ], self.gotAllRooms)
    ...
    def showInfoText(self, text = 'hello world'):
        ...
        if description and description != '':
            ...
            self.titleSequence = None
            self.titleSequence = Sequence(Func(self.showTitleText), Wait(3.1000000000000001), LerpColorScaleInterval(self.titleText, duration = 0.5, colorScale = Vec4(1, 1, 1, 0.0)), Func(self.hideTitleText))
