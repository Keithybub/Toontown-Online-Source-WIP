...
class DistributedGolfGreenGame(BattleBlocker.BattleBlocker):
    ...
    def __init__(self, cr):
        ...
        self.fullColor = Vec4(0.59999999999999998, 0.59999999999999998, 0.59999999999999998, 1.0)
        self.neighborColor = Vec4(0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1.0)
        ...
        self.tooLowFlag = 0
        self.toonPoints = (Point3(3.0, 13.0, 0.0), Point3(6.0, 13.0, 0.0), Point3(-3.0, 13.0, 0.0), Point3(-6.0, 13.0, 0.0))
        self.joinedToons = []
        ...
        self.gridDimX = 9
        self.gridDimZ = 15
        self.minX = -1.0 * (self.gridDimX + 0.37509999999999999) * 0.5 * self.cellSizeX
    ...
    def load(self):
        ...
        self.frame2D = DirectFrame(scale = 1.1000000000000001, relief = DGG.FLAT, frameSize = (-0.10000000000000001, 0.10000000000000001, -0.10000000000000001, -0.10000000000000001), frameColor = (0.73699999999999999, 0.57299999999999995, 0.34499999999999997, 0.29999999999999999))
        gui2 = loader.loadModel('phase_3/models/gui/quit_button')
        self.quitButton = DirectButton(parent = self.frame2D, relief = None, image = (gui2.find('**/QuitBtn_UP'), gui2.find('**/QuitBtn_DN'), gui2.find('**/QuitBtn_RLVR')), pos = (0.94999999999999996, 1.3, -0.68999999999999995), image_scale = (0.90000000000000002, 1.0, 1.0), text = TTLocalizer.BustACogExit, text_font = ToontownGlobals.getSignFont(), text0_fg = (1, 1, 1, 1), text0_shadow = (0, 0, 0, 1), text1_fg = (1, 1, 1, 1), text2_fg = (1, 1, 1, 1), text_scale = TTLocalizer.DGGGquitButton, text_pos = (0, -0.01), command = self._DistributedGolfGreenGame__leaveGame)
        self.quitButton.hide()
        self.instructions = DirectFrame(parent = self.frame2D, relief = None, image = DGG.getDefaultDialogGeom(), image_color = ToontownGlobals.GlobalDialogColor, image_scale = (1.2, 1.0, 1.0), text = TTLocalizer.GolfGreenGameDirections, text_font = ToontownGlobals.getSignFont(), text_align = TextNode.ALeft, text_wordwrap = 16, text_scale = 0.059999999999999998, text_pos = (-0.5, 0.29999999999999999), pos = (0.0, 0, -0.0))
        self.instructions.hide()
        imageCogBall = loader.loadModel('phase_12/models/bossbotHQ/bust_a_cog_ball_cog')
        imageCogBall.setHpr(0, 90, 0)
        self.instCogBall = DirectFrame(parent = self.instructions, relief = None, image = imageCogBall, image_color = ToontownGlobals.GlobalDialogColor, image_scale = (0.12, 0.12, 0.12), pos = (0.0, 0, -0.20000000000000001))
        buttons = loader.loadModel('phase_3/models/gui/dialog_box_buttons_gui')
        cancelImageList = (buttons.find('**/CloseBtn_UP'), buttons.find('**/CloseBtn_DN'), buttons.find('**/CloseBtn_Rllvr'))
        self.doneButton = DirectButton(parent = self.instructions, relief = None, image = cancelImageList, command = self.instructions.hide, pos = (0, 0, -0.40000000000000002))
        self.howToButton = DirectButton(parent = self.frame2D, relief = None, image = (gui2.find('**/QuitBtn_UP'), gui2.find('**/QuitBtn_DN'), gui2.find('**/QuitBtn_RLVR')), pos = (0.94999999999999996, 1.3, -0.81999999999999995), image_scale = (0.90000000000000002, 1.0, 1.0), text = TTLocalizer.BustACogHowto, text_font = ToontownGlobals.getSignFont(), text0_fg = (1, 1, 1, 1), text0_shadow = (0, 0, 0, 1), text1_fg = (1, 1, 1, 1), text2_fg = (1, 1, 1, 1), text_scale = TTLocalizer.DGGGhowToButton, text_pos = (0, -0.01), command = self.instructions.show)
        self.howToButton.hide()
        self.timerLabel = DirectLabel(parent = self.frame2D, relief = None, image = gui2.find('**/QuitBtn_UP'), pos = (0.90000000000000002, 1.3, -0.41999999999999998), image_scale = (0.5, 1.0, 1.0), text = 'Timer', text_font = ToontownGlobals.getSignFont(), text0_fg = (1, 1, 1, 1), text_scale = 0.044999999999999998, text_pos = (0, -0.01))
        self.timerLabel.hide()
        self.headPanel = loader.loadModel('phase_6/models/golf/headPanel')
        self.scoreBoard = DirectFrame(scale = 1.0, pos = (0.0, 0, 0.90000000000000002), relief = DGG.FLAT, parent = aspect2d, frameSize = (-0.34999999999999998, 0.34999999999999998, -0.050000000000000003, 0.050000000000000003), frameColor = (0.73699999999999999, 0.57299999999999995, 0.34499999999999997, 0.29999999999999999))
        ...
        self.bonusBoard = DirectFrame(parent = self.frame2D, relief = None, image_pos = (0, 0, 0.0), image_scale = (0.40000000000000002, 1, 0.40000000000000002), image_color = (1, 1, 1, 1), pos = (0.0, 1.5, 0.67000000000000004), scale = 1.0, text = 'You gotsa bonus fool!', text_font = ToontownGlobals.getSignFont(), text0_fg = (1, 1, 1, 1), text0_shadow = (0.0, 0.0, 0.0, 1), text_scale = 0.055, text_pos = (0, -0.10000000000000001), textMayChange = 1)
        ...
        self.aimbase.setScale(0.29999999999999999, 0.29999999999999999, 0.14999999999999999)
    ...
    def addToonHeadPanel(self, toon):
        tPanels = ToonHeadFrame.ToonHeadFrame(toon, (0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 0.59999999999999998), self.headPanel)
        ...
        tPanels.head.setScale(0.46999999999999997, 0.20000000000000001, 0.20000000000000001)
        ...
        tPanels.tag2.setScale(0.11700000000000001, 0.050000000000000003, 0.050000000000000003)
        tPanels.hide()
    ...
    def findGrid(self, x, z, force = 0):
        ...
        for countX in range(self.gridDimX):
            for countZ in range(self.gridDimZ):
                ...
                if self.grid[countX][countZ][0] == None and testDist < currentDist:
                    if force or self.hasNeighbor(countX, countZ) != None:
    ...
    def _DistributedGolfGreenGame__run(self, cont = 1):
        if cont and not (self.running):
            taskMgr.add(self._DistributedGolfGreenGame__run, 'GolfGreenGameTask')
            self.running = 1
                ...
                if testSprite and movingSprite:
                    if movingSpriteIndex != testSpriteIndex:
                        if movingSprite.isActive or testSprite.isActive:
                            if self.testDistance(movingSprite.spriteBase, testSprite.spriteBase) < self.radiusBall * 1.6499999999999999:
                                if not movingSprite.isActive and testSprite.isActive:
                                    if movingSprite.canCollide and testSprite.canCollide:
                                        self._DistributedGolfGreenGame__collide(movingSprite, testSprite)
    ...
    def announceGenerate(self):
        ...
        groundSquare = BuildGeometry.addSquareGeom(self.squareNode, self.sizeX, self.sizeZ, color = Vec4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 0.5))
    ...
    def initCollisionGeom(self):
        ...
        self.accept(self.enterEvent, self._DistributedGolfGreenGame__handleToonEnter)
    ...
    def clearToonTrack(self, avId):
        ...
        if oldTrack:
            ...
            if self._DistributedGolfGreenGame__toonTracks.get(avId):
                DelayDelete.cleanupDelayDeletes(self._DistributedGolfGreenGame__toonTracks[avId])
    ...
    def clearToonTracks(self):
        ...
        for key in keyList:
            if self._DistributedGolfGreenGame__toonTracks.has_key(key):
