...
class BossbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def __init__(self, hood, parentFSMState, doneEvent):
        ...
        self.fsm.addState(State.State('countryClubInterior', self.enterCountryClubInterior, self.exitCountryClubInterior, [
            'quietZone',
            'cogHQExterior']))
        for stateName in [
            'start',
    ...
    def makeSigns(self):
        ...
        def makeSign(topStr, signStr, textId):
            ...
            signText.setPosHpr(locator, 0, -0.10000000000000001, -0.25, 0, 0, 0)
