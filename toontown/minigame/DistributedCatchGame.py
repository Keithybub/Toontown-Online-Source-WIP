...
class DistributedCatchGame(DistributedMinigame):
    ...
    def setEveryoneDone(self):
        ...
        if self.fruitsCaught >= self.numFruits:
            ...
            perfectTextSubnode = hidden.attachNewNode(self._DistributedCatchGame__genText(TTLocalizer.CatchGamePerfect))
    ...
    def getIntroMovie(self):
        ...
        initialCamPosHpr = (-0.20999999999999999, -19.559999999999999, 13.94, 0.0, 26.57, 0.0)
        ...
        def getThrowIval(toon, hand, object, leftToon, isAnvil = 0):
            ...
            objIval = Track((grabFrame * framePeriod, Sequence(Func(object.reparentTo, hand), Func(object.setPosHpr, 0.050000000000000003, -0.13, 0.62, 0, 0, 336.80000000000001), LerpScaleInterval(object, objScaleDur, 1.0, startScale = 0.10000000000000001, blendType = 'easeInOut'))), (releaseFrame * framePeriod, trajIval))
