...
class DistributedTargetGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.help = DirectLabel(parent = aspect2d, relief = None, pos = (-0.0, 0, -0.80000000000000004), text = TTLocalizer.TargetGameCountdown, text_scale = 0.080000000000000002, text_fg = (1, 1, 1, 1))
        self.help.hide()
        self.fogOver = FogOverlay.FogOverlay(Point3(self.CLOUD_COLOR[0], self.CLOUD_COLOR[1], self.CLOUD_COLOR[2]))
        self.scoreboard = DirectFrame(parent = aspect2d, relief = None, geom = DGG.getDefaultDialogGeom(), geom_color = ToontownGlobals.GlobalDialogColor, geom_scale = (1.75, 1, 0.75), pos = (0, 0, 0.58699999999999997))
        self.roundLabel = DirectLabel(parent = self.scoreboard, relief = None, pos = (0, 0, 0.28000000000000003), text = TTLocalizer.TargetGameBoard % self.round, text_scale = 0.080000000000000002)
        av1Label = DirectLabel(parent = self.scoreboard, relief = None, pos = (-0.80000000000000004, 0, 0.14000000000000001), text_align = TextNode.ALeft, text = ' ', text_scale = 0.080000000000000002)
        av2Label = DirectLabel(parent = self.scoreboard, relief = None, pos = (-0.80000000000000004, 0, 0.02), text_align = TextNode.ALeft, text = ' ', text_scale = 0.080000000000000002)
        av3Label = DirectLabel(parent = self.scoreboard, relief = None, pos = (-0.80000000000000004, 0, -0.10000000000000001), text_align = TextNode.ALeft, text = ' ', text_scale = 0.080000000000000002)
        av4Label = DirectLabel(parent = self.scoreboard, relief = None, pos = (-0.80000000000000004, 0, -0.22), text_align = TextNode.ALeft, text = ' ', text_scale = 0.080000000000000002)
        score1Label = DirectLabel(parent = self.scoreboard, relief = None, pos = (0.80000000000000004, 0, 0.14000000000000001), text_align = TextNode.ARight, text = ' ', text_scale = 0.080000000000000002)
        score2Label = DirectLabel(parent = self.scoreboard, relief = None, pos = (0.80000000000000004, 0, 0.02), text_align = TextNode.ARight, text = ' ', text_scale = 0.080000000000000002)
        score3Label = DirectLabel(parent = self.scoreboard, relief = None, pos = (0.80000000000000004, 0, -0.10000000000000001), text_align = TextNode.ARight, text = ' ', text_scale = 0.080000000000000002)
        score4Label = DirectLabel(parent = self.scoreboard, relief = None, pos = (0.80000000000000004, 0, -0.22), text_align = TextNode.ARight, text = ' ', text_scale = 0.080000000000000002)
        self.avLabels = [
            av1Label,
            av2Label,
            av3Label,
        ...
        self._DistributedTargetGame__textGen.setFont(ToontownGlobals.getSignFont())
        self._DistributedTargetGame__textGen.setAlign(TextNode.ACenter)
        self.powerBar = DirectWaitBar(guiId = 'launch power bar', pos = (0.0, 0, -0.65000000000000002), relief = DGG.SUNKEN, frameSize = (-2.0, 2.0, -0.20000000000000001, 0.20000000000000001), borderWidth = (0.02, 0.02), scale = 0.25, range = 100, sortOrder = 50, frameColor = (0.5, 0.5, 0.5, 0.5), barColor = (1.0, 0.0, 0.0, 1.0), text = '0%', text_scale = 0.26000000000000001, text_fg = (1, 1, 1, 1), text_align = TextNode.ACenter, text_pos = (0, -0.050000000000000003))
        ...
        open.hide()
        open.setPos(0.10000000000000001, 0.20000000000000001, -0.10000000000000001)
        ...
        for typeIndex in range(len(self.targetList)):
            for targetIndex in range(self.targetList[typeIndex]):
                ...
                while not goodPlacement:
                    placeX = random.random() * fieldWidth * 0.59999999999999998 - fieldWidth * 0.59999999999999998 * 0.5
                    placeY = (random.random() * 0.59999999999999998 + 0.0 + 0.40000000000000002 * (self.placeValue * 1.0 / highestValue * 1.0)) * fieldLength
    ...
    def onstage(self):
        ...
        if base.wantFog:
            ...
            self._DistributedTargetGame__fog.setLinearRange(0.10000000000000001, self.FOGDISTGROUND)
        ...
        self._DistributedTargetGame__addToonDropShadow(self.getAvatar(self.localAvId))
    ...
    def handleDisabledAvatar(self, avId):
        ...
        self._DistributedTargetGame__removeToonDropShadow(self.remoteToons[avId])
    ...
    def _DistributedTargetGame__spawnUpdatePowerBarTask(self):
        ...
        taskMgr.add(self._DistributedTargetGame__updatePowerBarTask, self.UPDATE_POWERBAR_TASK, priority = self.UPDATE_POWER_BAR_PRIORITY)
        self.rubberSound.play()
        self.bandVolume = 0.0
    ...
    def _DistributedTargetGame__spawnGameDoneTask(self):
        ...
        taskMgr.doMethodLater(5.0, self._DistributedTargetGame__gameDone, self.GAME_DONE_TASK)
    ...
    def _DistributedTargetGame__spawnUpdateLocalToonTask(self):
        ...
        taskMgr.add(self._DistributedTargetGame__updateLocalToonTask, self.UPDATE_LOCALTOON_TASK, priority = self.UPDATE_LOCAL_TOON_PRIORITY)
    ...
    def _DistributedTargetGame__initPosBroadcast(self):
        ...
        self._DistributedTargetGame__lastPosBroadcast = self.getAvatar(self.localAvId).getPos()
    ...
    def _DistributedTargetGame__spawnUpdateEnvironTask(self):
        ...
        taskMgr.add(self._DistributedTargetGame__updateEnvironTask, self.UPDATE_ENVIRON_TASK)
    ...
    def _DistributedTargetGame__updatePowerBarTask(self, task):
        ...
        if self.lastPressTime:
            ...
            if self.ticker >= 0.10000000000000001:
                ...
                self.power -= 1.0 + 0.20000000000000001 * self.power * powerDiv * self.power * powerDiv
        ...
        self.stretchY = 0.90000000000000002 * self.stretchY + 0.10000000000000001 * self.power
        self.stretchX = 0.90000000000000002 * self.stretchX + 0.10000000000000001 * self.launchLaterial
    ...
    def _DistributedTargetGame__addDropShadow_INTERNAL(self, object, scale_x, scale_y, scale_z, list):
    ...
    def _DistributedTargetGame__addToonDropShadow(self, object):
        self._DistributedTargetGame__addDropShadow_INTERNAL(object, 0.5, 0.5, 0.5, self.toonDropShadows)

    
    def _DistributedTargetGame__removeToonDropShadow(self, object):
        self._DistributedTargetGame__removeDropShadow_INTERNAL(object, self.toonDropShadows)
    ...
    def _DistributedTargetGame__spawnUpdateShadowsTask(self):
        ...
        taskMgr.add(self._DistributedTargetGame__updateShadowsTask, self.UPDATE_SHADOWS_TASK, priority = self.UPDATE_SHADOWS_PRIORITY)
    ...
    def _DistributedTargetGame__spawnCollisionDetectionTask(self):
        ...
        taskMgr.add(self._DistributedTargetGame__collisionDetectionTask, self.COLLISION_DETECTION_TASK, priority = self.COLLISION_DETECTION_PRIORITY)
    ...
    def setTimeBase(self, timestamp):
        ...
        self._DistributedTargetGame__timeBase = globalClockDelta.networkToLocalTime(timestamp)
