...
class DistributedTagGame(DistributedMinigame):
    ...
    def enterPlay(self):
        ...
        for i in range(self.numPlayers):
            ...
            scorePanel.setPos(1.1200000000000001, 0.0, 0.28000000000000003 * i - 0.34000000000000002)
    ...
    def setIt(self, avId):
        ...
        while tLen < duration:
            ...
            bounceTrack.append(LerpFunctionInterval(bounceFunc, fromData = 0.0, toData = dur, duration = dur, extraArgs = [
                trajectory]))
            tLen += dur
            zVel *= decay
