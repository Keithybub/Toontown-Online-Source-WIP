...
class DistributedVineGame(DistributedMinigame):
    ...
    def __init__(self, cr):
        ...
        self.cameraTopView = (17.600000000000001, 6.1875600000000004, 43.995600000000003, 0, -89, 0)
        self.cameraThreeQuarterView = (0, -63.200000000000003, 16.300000000000001, 0, 0, 0)
    ...
    def enterPlay(self):
        ...
        for i in xrange(self.numPlayers):
            ...
            scorePanel.setPos(0.75 - spacing * (self.numPlayers - 1 - i), 0.0, 0.84999999999999998)
    ...
    def _DistributedVineGame__spawnUpdateLocalToonTask(self):
        ...
        taskMgr.add(self._DistributedVineGame__updateLocalToonTask, self.UpdateLocalToonTask)
    ...
    def _DistributedVineGame__updateLocalToonTask(self, task):
        ...
        if not curInfo:
            ...
            if not newT != curT:
                if self.getClimbDir(avId) or not (curT == 1.0) or oldClimbDir != climbDir:
    ...
    def createRadar(self):
        ...
        self.cDr.setClearColor(Vec4(0.84999999999999998, 0.94999999999999996, 0.94999999999999996, 1))
        self.cDr.setCamera(self.cCam)
        self.radarSeparator = DirectFrame(relief = None, image = DGG.getDefaultDialogGeom(), image_color = (0.20000000000000001, 0.0, 0.80000000000000004, 1), image_scale = (2.6499999999999999, 1.0, 0.01), pos = (0, 0, -0.8125))
