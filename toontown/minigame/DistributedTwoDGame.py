...
class DistributedTwoDGame(DistributedMinigame):
    ...
    def enterPlay(self, timestamp):
        ...
        self.accept('twoDTreasureGrabbed', self._DistributedTwoDGame__treasureGrabbed)
        self.accept('enemyShot', self._DistributedTwoDGame__enemyShot)
        taskMgr.remove(self.UpdateLocalToonTask)
        taskMgr.add(self._DistributedTwoDGame__updateLocalToonTask, self.UpdateLocalToonTask, priority = 1)
    ...
    def enterShowScores(self):
        ...
        scorePanelLocs = (((cX, bY),), ((lX, bY), (rX, bY)), ((cX, bY), (lX, bY), (rX, bY)), ((lX, tY), (rX, tY), (lX, bY), (rX, bY)))
    ...
    def setupHeadCollision(self):
        ...
        self.accept('enterheadCollSphere-into-floor1', self._DistributedTwoDGame__handleHeadCollisionIntoFloor)
        self.accept('headCollSphere-exit-floor1', self._DistributedTwoDGame__handleHeadCollisionExitFloor)
    ...
    def _DistributedTwoDGame__treasureGrabbed(self, sectionIndex, treasureIndex):
