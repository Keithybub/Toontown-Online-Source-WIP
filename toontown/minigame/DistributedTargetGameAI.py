...
class DistributedTargetGameAI(DistributedMinigameAI):
    ...
    def __init__(self, air, minigameId):
        ...
        try:
            ...
            self._DistributedTargetGameAI__timeBase = globalClockDelta.localToNetworkTime(globalClock.getRealTime())
            self.round = 2
    ...
    def enterResetRound(self):
        ...
        self.barrierScore.cleanup()
        del self.barrierScore
        taskMgr.doMethodLater(0.10000000000000001, self.gotoFly, self.taskName('roundReset'))
