...
class Purchase(PurchaseBase):
    ...
    def load(self):
        ...
        headFramePosList = (Vec3(0.105, 0, -0.38400000000000001), Vec3(0.105, 0, -0.77600000000000002), Vec3(0.84999999999999998, 0, -0.55500000000000005), Vec3(-0.65400000000000003, 0, -0.55500000000000005))
        AVID_INDEX = 0
        LAYOUT_INDEX = 1
        TOON_INDEX = 2
        self.avInfoArray = [
        ...
        doors.removeNode()
        self.convertingVotesToBeansLabel = DirectLabel(text = TTLocalizer.TravelGameConvertingVotesToBeans, text_fg = VBase4(1, 1, 1, 1), relief = None, pos = (0.0, 0, -0.57999999999999996), scale = 0.074999999999999997)
        self.convertingVotesToBeansLabel.hide()
        self.rewardDoubledJellybeanLabel = DirectLabel(text = TTLocalizer.PartyRewardDoubledJellybean, text_fg = (1.0, 0.125, 0.125, 1.0), text_shadow = (0, 0, 0, 1), relief = None, pos = (0.0, 0, -0.67000000000000004), scale = 0.080000000000000002)
    ...
    def setupUnexpectedExitHooks(self):
        for avId in self.ids:
            if base.cr.doId2do.has_key(avId):
                ...
                self.accept(eventName, self._Purchase__handleUnexpectedExit, extraArgs = [
                    avId])
...
class PurchaseHeadFrame(DirectFrame):
    ...
    def __init__(self, av, purchaseModels):
        ...
        self.statusLabel = DirectLabel(parent = self, relief = None, text = '', text_scale = TTLocalizer.PstatusLabel, text_wordwrap = 7.5, text_fg = (0.050000000000000003, 0.14000000000000001, 0.40000000000000002, 1), text_pos = (0.10000000000000001, 0, 0))
        self.av = av
