...
class DistributedRingGameAI(DistributedMinigameAI):
    ...
    def __init__(self, air, minigameId):
        ...
        try:
            ...
            self._DistributedRingGameAI__timeBase = globalClockDelta.localToNetworkTime(globalClock.getRealTime())
    ...
    def setToonGotRing(self, success):
        ...
        if not success:
            self._DistributedRingGameAI__ringResultBitfield[ringGroupIndex] |= 1 << self.avIdList.index(avId)
