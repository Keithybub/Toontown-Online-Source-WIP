...
class MazeMapGui(DirectFrame):
    ...
    def __init__(self, mazeCollTable, maskResolution = None, radiusRatio = None, bgColor = (0.80000000000000004, 0.80000000000000004, 0.80000000000000004), fgColor = (0.5, 0.5, 0.5, 1.0)):
    ...
    def _createMaskTextureCard(self):
        ...
        cm.setFrame(-1.1000000000000001, 1.1000000000000001, -1.1000000000000001, 1.1000000000000001)
    ...
    def gui2pos(self, x, y):
        return ((x / self._maskResolution) * 2.0 - 0.96999999999999997, 0, (y / self._maskResolution) * -2.0 + 1.02)
