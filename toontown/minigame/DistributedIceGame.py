...
class DistributedIceGame(DistributedMinigame.DistributedMinigame, DistributedIceWorld.DistributedIceWorld):
    ...
    def enterInputChoice(self):
        ...
        taskMgr.add(self._DistributedIceGame__aimTask, self.uniqueName('aimtask'))
    ...
    def enterMoveTires(self):
        ...
        self.startSim()
        taskMgr.add(self._DistributedIceGame__moveTiresTask, self.uniqueName('moveTiresTtask'))
