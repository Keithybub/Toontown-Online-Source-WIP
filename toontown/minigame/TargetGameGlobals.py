...
targetColors = ((TTLocalizer.ColorRed, VBase4(1.0, 0.40000000000000002, 0.20000000000000001, 1.0)), (TTLocalizer.ColorGreen, VBase4(0.0, 0.90000000000000002, 0.20000000000000001, 1.0)), (TTLocalizer.ColorOrange, VBase4(1.0, 0.5, 0.25, 1.0)), (TTLocalizer.ColorPurple, VBase4(1.0, 0.0, 1.0, 1.0)), (TTLocalizer.ColorWhite, VBase4(1.0, 1.0, 1.0, 1.0)), (TTLocalizer.ColorBlack, VBase4(0.0, 0.0, 0.0, 1.0)), (TTLocalizer.ColorYellow, VBase4(1.0, 1.0, 0.20000000000000001, 1.0)))
ENVIRON_LENGTH = 300
ENVIRON_WIDTH = 150.0
ringColorSelection = [
    (0, 1, 2),
