...
class DistributedRaceGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.chanceCardText = OnscreenText('', fg = (1.0, 0, 0, 1), scale = 0.14000000000000001, font = ToontownGlobals.getSignFont(), wordwrap = 14, pos = (0.0, 0.20000000000000001), mayChange = 1)
    ...
    def showChanceCard(self, task):
        ...
        self.chanceCard.lerpPosHpr(19.620000000000001, 13.41, 13.140000000000001, 270, 0, -85.239999999999995, 1.0, other = camera, task = 'cardLerp')
        return Task.done
