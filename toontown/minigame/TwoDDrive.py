...
class TwoDDrive:
    ...
    def start(self):
        ...
        taskMgr.add(self._TwoDDrive__update, TwoDDrive.TASK_NAME, priority = self.priority)
            ...
            if not xVel or yVel:
                ...
                if self.lastXVel or self.lastYVel:
                    ...
                    if not yVel:
                        ...
                        taskMgr.doMethodLater(0.050000000000000003, setAtRestHeading, TwoDDrive.SET_ATREST_HEADING_TASK)
                    else:
