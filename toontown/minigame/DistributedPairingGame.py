...
class DistributedPairingGame(DistributedMinigame):
    ...
    def __init__(self, cr):
        ...
        self.cameraThreeQuarterView = (14.0, -8.9335199999999997, 33.4497, 0, -62.890000000000001, 0)
        self.deckSeed = 0
        self.faceUpList = []
    ...
    def _DistributedPairingGame__beginSignal(self, mouseParam):
        ...
        taskMgr.doMethodLater(1.6699999999999999, self._DistributedPairingGame__continueSignal, 'pairGameContinueSignal')
