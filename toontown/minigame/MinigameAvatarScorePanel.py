...
class MinigameAvatarScorePanel(DirectFrame):
    ...
    def __init__(self, avId, avName):
        ...
        self.scoreText = DirectLabel(self, relief = None, text = '0', text_scale = TTLocalizer.MASPscoreText, pos = (0.10000000000000001, 0.0, -0.089999999999999997))
        if self.avatar:
            ...
            self.laffMeter = None
        self.nameText = DirectLabel(self, relief = None, text = avName, text_scale = TTLocalizer.MASPnameText, text_pos = (0.0, 0.059999999999999998), text_wordwrap = 7.5, text_shadow = (1, 1, 1, 1))
        self.show()
