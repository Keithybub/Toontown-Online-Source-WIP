...
class DistributedIceWorld(DistributedMinigamePhysicsWorld.DistributedMinigamePhysicsWorld):
    ...
    def setupSimulation(self):
        ...
        self.world.setSurfaceEntry(0, 1, 0.20000000000000001, 0, 0, 0, 0, 0, 0.10000000000000001)
        self.world.setSurfaceEntry(0, 0, 0.10000000000000001, 0.90000000000000002, 0.10000000000000001, 0, 0, 0, 0)
        self.world.setSurfaceEntry(0, 2, 0.90000000000000002, 0.90000000000000002, 0.10000000000000001, 0, 0, 0, 0)
