...
class VoteResultsTrolleyPanel(DirectFrame):
    ...
    def __init__(self, numPlayers, avIdList, votes, directions, namesList, disconnectedList, directionToGo, directionReason, directionTotals, *args, **kwargs):
        ...
        self.upLabel = DirectLabel(parent = self, relief = None, pos = (-0.5, 0, 0.059999999999999998), text = TTLocalizer.TravelGameDirections[0] + ':', text_fg = (0.0, 0.0, 1.0, 1.0), text_scale = 0.050000000000000003, text_align = TextNode.ARight)
        self.downLabel = DirectLabel(parent = self, relief = None, pos = (0.5, 0, 0.059999999999999998), text = TTLocalizer.TravelGameDirections[1] + ':', text_fg = (1.0, 0.0, 0.0, 1.0), text_scale = 0.050000000000000003, text_align = TextNode.ARight)
        self.totalVotesUpLabel = DirectLabel(parent = self.upLabel, relief = None, pos = (0.20000000000000001, 0, 0.0), text = '0', text_fg = (0.0, 0.0, 1.0, 1.0), text_scale = 0.050000000000000003, text_align = TextNode.ARight)
        self.totalVotesDownLabel = DirectLabel(parent = self.downLabel, relief = None, pos = (0.20000000000000001, 0, 0.0), text = '0', text_fg = (1.0, 0.0, 0.0, 1.0), text_scale = 0.050000000000000003, text_align = TextNode.ARight)
        ...
        for index in range(self.numPlayers):
            ...
            if av:
                ...
                if self.votes[index] > 0:
                    newLabel = DirectLabel(parent = aspect2d, relief = None, pos = labelPos, text = 'test', text_fg = (1, 1, 1, 1), text_scale = 0.10000000000000001, text_align = TextNode.ACenter, text_font = ToontownGlobals.getSignFont(), text_pos = (0, -0.01, 0))
                else:
                    newLabel = DirectLabel(parent = aspect2d, geom = DGG.getDefaultDialogGeom(), geom_scale = (0.20000000000000001, 1, 0.20000000000000001), relief = None, pos = labelPos, text = 'test', text_fg = (0.5, 0.5, 0.5, 1), text_scale = 0.10000000000000001, text_align = TextNode.ACenter, text_font = ToontownGlobals.getSignFont(), text_pos = (0, -0.035000000000000003, 0))
    ...
    def getRowPos(self, place):
        return Point3(-0.71999999999999997, -0.01, 0.0 - place * 0.10000000000000001)
    ...
    def startMovie(self):
        ...
        if self.localAvatarWon:
            ...
            soundAndWait.append(SoundInterval(self.loseVoteSfx, duration = 0.42999999999999999))
