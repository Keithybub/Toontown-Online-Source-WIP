...
class TwoDSectionMgr(DirectObject):
    ...
    def setupEndSection(self, index):
        ...
        sdSign.setPosHprScale(0, 1.8999999999999999, 15, 0, 0, 0, elevatorSignSF, elevatorSignSF, elevatorSignSF * aspectSF)
        sdSign.node().setEffect(DecalEffect.make())
        sdText = DirectGui.OnscreenText(text = TTLocalizer.TwoDGameElevatorExit, font = ToontownGlobals.getSuitFont(), pos = (0, -0.34000000000000002), scale = 0.14999999999999999, mayChange = False, parent = sdSign)
