...
class DistributedMazeGame(DistributedMinigame):
    ...
    def enterPlay(self):
        ...
        orthoDrive = OrthoDrive(self.TOON_SPEED, maxFrameMove = self.MAX_FRAME_MOVE, customCollisionCallback = self._DistributedMazeGame__doMazeCollisions, priority = 1)
    ...
    def _DistributedMazeGame__spawnCameraTask(self):
        ...
        taskMgr.add(self._DistributedMazeGame__cameraTask, self.CAMERA_TASK, priority = 45)
