...
class RubberBand:
    ...
    def redraw(self, task):
        ...
        colorLow = 0.5
        shapeVertexs = []
        shapeVertexs.append((self.post1Pos[0], self.post1Pos[1], bandBottomOrigin + 0.45000000000000001))
        shapeVertexs.append((self.post1Pos[0], self.post1Pos[1], bandTopOrigin + 0.45000000000000001))
        ...
        colorMultList.append(colorLow)
        colorMultList.append(colorHigh)
        shapeVertexs.append((self.post2Pos[0], self.post2Pos[1], bandBottomOrigin + 0.45000000000000001))
        shapeVertexs.append((self.post2Pos[0], self.post2Pos[1], bandTopOrigin + 0.45000000000000001))
        colorMultList.append(colorLow)
        colorMultList.append(colorHigh)
