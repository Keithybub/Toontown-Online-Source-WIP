...
class DistributedBossCog(DistributedAvatar.DistributedAvatar, BossCog.BossCog):
    ...
    def setToonIds(self, involvedToons, toonsA, toonsB):
        ...
        self.cr.relatedObjectMgr.abortRequest(self.toonRequest)
        self.gotAllToons = 0
        self.toonRequest = self.cr.relatedObjectMgr.requestObjects(self.involvedToons, allCallback = self._DistributedBossCog__gotAllToons, eachCallback = self.gotToon)
    ...
    def setBattleExperience(self, id0, origExp0, earnedExp0, origQuests0, items0, missedItems0, origMerits0, merits0, parts0, id1, origExp1, earnedExp1, origQuests1, items1, missedItems1, origMerits1, merits1, parts1, id2, origExp2, earnedExp2, origQuests2, items2, missedItems2, origMerits2, merits2, parts2, id3, origExp3, earnedExp3, origQuests3, items3, missedItems3, origMerits3, merits3, parts3, id4, origExp4, earnedExp4, origQuests4, items4, missedItems4, origMerits4, merits4, parts4, id5, origExp5, earnedExp5, origQuests5, items5, missedItems5, origMerits5, merits5, parts5, id6, origExp6, earnedExp6, origQuests6, items6, missedItems6, origMerits6, merits6, parts6, id7, origExp7, earnedExp7, origQuests7, items7, missedItems7, origMerits7, merits7, parts7, deathList, uberList, helpfulToons):
        ...
        entries = ((id0, origExp0, earnedExp0, origQuests0, items0, missedItems0, origMerits0, merits0, parts0), (id1, origExp1, earnedExp1, origQuests1, items1, missedItems1, origMerits1, merits1, parts1), (id2, origExp2, earnedExp2, origQuests2, items2, missedItems2, origMerits2, merits2, parts2), (id3, origExp3, earnedExp3, origQuests3, items3, missedItems3, origMerits3, merits3, parts3), (id4, origExp4, earnedExp4, origQuests4, items4, missedItems4, origMerits4, merits4, parts4), (id5, origExp5, earnedExp5, origQuests5, items5, missedItems5, origMerits5, merits5, parts5), (id6, origExp6, earnedExp6, origQuests6, items6, missedItems6, origMerits6, merits6, parts6), (id7, origExp7, earnedExp7, origQuests7, items7, missedItems7, origMerits7, merits7, parts7))
    ...
    def rollBossToPoint(self, fromPos, fromHpr, toPos, toHpr, reverse):
        ...
        track = Sequence(Func(self.setPos, fromPos), Func(self.headsUp, toPos), Parallel(self.hprInterval(turnTime, toHpr, fromHpr), self.rollLeftTreads(turnTime, leftRate), self.rollRightTreads(turnTime, -leftRate)), Parallel(LerpFunctionInterval(self.rollBoss, duration = rollTime, extraArgs = [
            fromPos,
    ...
    def flashGreen(self):
        ...
        if not self.isEmpty():
            self.setColorScale(1, 1, 1, 1)
            i = Sequence(self.colorScaleInterval(0.10000000000000001, colorScale = VBase4(0, 1, 0, 1)), self.colorScaleInterval(0.29999999999999999, colorScale = VBase4(1, 1, 1, 1)))
            self.flashInterval = i
            i.start()
    ...
    def loseCogSuits(self, toons, battleNode, camLoc, arrayOfObjs = False):
        ...
        for toon in toonArray:
            ...
            suitsOff.append(Sequence(Func(dustCloud.reparentTo, toon), Parallel(dustCloud.track, Sequence(Wait(0.29999999999999999), Func(toon.takeOffSuit), Func(toon.sadEyes), Func(toon.blinkEyes), Func(toon.play, 'slip-backward'), Wait(0.69999999999999996))), Func(dustCloud.detachNode), Func(dustCloud.destroy)))
    ...
    def doDirectedAttack(self, avId, attackCode):
        ...
        if toon:
            ...
            seq = Sequence(ParallelEndTogether(self.pelvis.hprInterval(1, VBase3(toToonH, 0, 0)), neutral1Anim), extraAnim, Parallel(Sequence(Wait(0.19), gearTrack, Func(gearRoot.detachNode), self.pelvis.hprInterval(0.20000000000000001, VBase3(0, 0, 0))), Sequence(throwAnim, neutral2Anim)))
    ...
    def enterElevator(self):
        ...
        ival = Sequence(ElevatorUtils.getRideElevatorInterval(self.elevatorType), ElevatorUtils.getRideElevatorInterval(self.elevatorType), self.openDoors, Func(camera.wrtReparentTo, render), Func(self._DistributedBossCog__doneElevator))
    ...
    def enterIntroduction(self):
        ...
        delayDeletes = []
        seq = Sequence(self.makeIntroductionMovie(delayDeletes), Func(self._DistributedBossCog__beginBattleOne), name = intervalName)
    ...
    def enterBattleThree(self):
        ...
        self.accept('friendAvatar', self._DistributedBossCog__handleFriendAvatar)
        self.accept('avatarDetails', self._DistributedBossCog__handleAvatarDetails)
        NametagGlobals.setMasterArrowsOn(0)
    ...
    def _DistributedBossCog__handleFriendAvatar(self, avId, avName, avDisableName):
    ...
    def _DistributedBossCog__handleAvatarDetails(self, avId, avName, playerId = None):
    ...
    def wearCogSuits(self, toons, battleNode, camLoc, arrayOfObjs = False, waiter = False):
        ...
        for toon in toonArray:
            ...
            suitsOff.append(Sequence(Func(dustCloud.reparentTo, toon), Parallel(dustCloud.track, Sequence(Wait(0.29999999999999999), Func(self.putToonInCogSuit, toon), makeWaiter, Wait(0.69999999999999996))), Func(dustCloud.detachNode)))
