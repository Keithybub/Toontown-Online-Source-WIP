...
if AppRunnerGlobal.appRunner:
    ...
    searchPath.appendDirectory(Filename.fromOsSpecific(os.path.expandvars('resources/src/quest')))
    searchPath.appendDirectory(Filename.fromOsSpecific('resources/toontown/src/quest'))
