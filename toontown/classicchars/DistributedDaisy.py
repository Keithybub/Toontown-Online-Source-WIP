...
class DistributedDaisy(DistributedCCharBase.DistributedCCharBase):
    ...
    def enterNeutral(self):
        self.neutral.enter()
        self.acceptOnce(self.neutralDoneEvent, self._DistributedDaisy__decideNextState)
    ...
    def enterWalk(self):
        self.walk.enter()
        self.acceptOnce(self.walkDoneEvent, self._DistributedDaisy__decideNextState)
