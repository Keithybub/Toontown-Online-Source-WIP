...
class DistributedFrankenDonald(DistributedDonald.DistributedDonald):
    ...
    def enterNeutral(self):
        ...
        self.neutral.enter()
        self.acceptOnce(self.neutralDoneEvent, self._DistributedFrankenDonald__decideNextState)

    
    def enterWalk(self):
        self.notify.debug('Walking ' + self.getName() + '...')
        self.walk.enter()
        self.acceptOnce(self.walkDoneEvent, self._DistributedFrankenDonald__decideNextState)
