...
class GolfPage(ShtikerPage):
    ...
    def load(self):
        ...
        self.recordsTab = DirectButton(parent = self, relief = None, text = TTLocalizer.GolfPageRecordsTab, text_scale = TTLocalizer.GPrecordsTab, text_align = TextNode.ALeft, image = gui.find('**/tabs/polySurface2'), image_pos = (0.12, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            PageMode.Records], pos = TTLocalizer.GPrecordsTabPos)
        self.trophyTab = DirectButton(parent = self, relief = None, text = TTLocalizer.GolfPageTrophyTab, text_scale = TTLocalizer.GPtrophyTab, text_pos = TTLocalizer.GPtrophyTabTextPos, text_align = TextNode.ALeft, image = gui.find('**/tabs/polySurface3'), image_pos = (-0.28000000000000003, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            PageMode.Trophy], pos = TTLocalizer.GPtrophyTabPos)
...
class GolfTrophiesUI(DirectFrame):
    ...
    def load(self):
        ...
        self.currentHistory = DirectLabel(parent = self, relief = None, text = '', text_scale = 0.050000000000000003, text_fg = (0, 0, 0.94999999999999996, 1.0), text_pos = (0, -0.65000000000000002))
    ...
    def growCup(self, index, pos):
        self.cupPanels[index]['image_color'] = Vec4(1.0, 1.0, 0.80000000000000004, 1.0)
        if index < GolfGlobals.NumTrophies:
    ...
    def updateTrophies(self):
        for t in range(len(self.trophyPanels)):
            ...
            trophyPanel['image_color'] = Vec4(0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1)
        ...
        for t in range(len(self.cupPanels)):
            ...
            cupPanel['image_color'] = Vec4(0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1)
