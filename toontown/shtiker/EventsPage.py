...
class EventsPage(ShtikerPage.ShtikerPage):
    ...
    def loadTabs(self):
        ...
        self.hostTab = DirectButton(parent = self, relief = None, text = TTLocalizer.EventsPageHostTabName, text_scale = TTLocalizer.EPhostTab, text_align = TextNode.ACenter, text_pos = (0.12, 0.0), image = gui.find('**/tabs/polySurface1'), image_pos = (0.55000000000000004, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            EventsPage_Host], pos = (0.92000000000000004, 0, 0.55000000000000004))
        self.invitedTab = DirectButton(parent = self, relief = None, text = TTLocalizer.EventsPageInvitedTabName, text_scale = TTLocalizer.EPinvitedTab, text_pos = (0.12, 0.0), text_align = TextNode.ACenter, image = gui.find('**/tabs/polySurface2'), image_pos = (0.12, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            EventsPage_Invited], pos = (0.92000000000000004, 0, 0.10000000000000001))
        self.calendarTab = DirectButton(parent = self, relief = None, text = TTLocalizer.EventsPageCalendarTabName, text_scale = TTLocalizer.EPcalendarTab, text_pos = (0.12, 0.0), text_align = TextNode.ACenter, image = gui.find('**/tabs/polySurface2'), image_pos = (0.12, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            EventsPage_Calendar], pos = (0.92000000000000004, 0, 0.10000000000000001))
        self.newsTab = DirectButton(parent = self, relief = None, text = TTLocalizer.EventsPageNewsTabName, text_scale = TTLocalizer.EPnewsTab, text_pos = (0.12, 0.0), text_align = TextNode.ACenter, image = gui.find('**/tabs/polySurface2'), image_pos = (0.12, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            EventsPage_News], pos = (0.92000000000000004, 0, 0.10000000000000001))
        self.newsTab.hide()
        if self.UseNewsTab:
            self.newsTab.show()
            self.calendarTab.setPos(-0.75, 0, 0.77500000000000002)
            self.hostTab.setPos(-0.33000000000000002, 0, 0.77500000000000002)
            self.invitedTab.setPos(0.089999999999999997, 0, 0.77500000000000002)
            self.newsTab.setPos(0.51000000000000001, 0, 0.77500000000000002)
        else:
            self.calendarTab.setPos(-0.55000000000000004, 0, 0.77500000000000002)
    ...
    def loadHostingTab(self):
        ...
        self.publicButton = DirectCheckButton(parent = self.hostedPartyDisplay, relief = None, scale = 0.10000000000000001, boxBorder = 0.080000000000000002, boxImage = (uncheckedImage, checkedImage, None), boxImageScale = 10, boxRelief = None, text = TTLocalizer.EventsPageHostTabToggleToPublic, text_align = TextNode.ALeft, text_scale = TTLocalizer.EPpublicButton, pos = pos, command = self._EventsPage__changePublicPrivate, indicator_pos = (-0.69999999999999996, 0, 0.20000000000000001))
        pos = self.hostingGui.find('**/private_text_locator').getPos()
        self.privateButton = DirectCheckButton(parent = self.hostedPartyDisplay, relief = None, scale = 0.10000000000000001, boxBorder = 0.080000000000000002, boxImage = (uncheckedImage, checkedImage, None), boxImageScale = 10, boxRelief = None, text = TTLocalizer.EventsPageHostTabToggleToPrivate, text_align = TextNode.ALeft, text_scale = TTLocalizer.EPprivateButton, pos = pos, command = self._EventsPage__changePublicPrivate, indicator_pos = (-0.69999999999999996, 0, 0.20000000000000001))
    ...
    def loadInvitationsTab(self):
        ...
        self.invitePartyGoButton = DirectButton(parent = self.invitationDisplay, relief = None, geom = (self.invitationGui.find('**/startButton_up'), self.invitationGui.find('**/startButton_down'), self.invitationGui.find('**/startButton_rollover'), self.invitationGui.find('**/startButton_inactive')), text = TTLocalizer.EventsPageInviteGoButton, text_scale = TTLocalizer.EPinvitePartyGoButton, text_pos = (pos[0], pos[2]), textMayChange = True, command = self._inviteStartParty)
        self.invitationDateTimeLabel = DirectLabel(parent = self.invitationDisplay, relief = None, text = '', textMayChange = True, text_scale = 0.070000000000000007, pos = (0, 0, -0.65000000000000002))

    
    def loadCalendarTab(self):
        self.calendarDisplay = self.attachNewNode('calendar')
        self.toontownTimeLabel = DirectLabel(parent = self.calendarDisplay, pos = (0.17499999999999999, 0, -0.68999999999999995), text_align = TextNode.ARight, relief = None, text = TTLocalizer.EventsPageToontownTimeIs, text_scale = 0.065000000000000002, text_font = ToontownGlobals.getMinnieFont(), text_fg = (255 / 255.0, 146 / 255.0, 113 / 255.0, 1), textMayChange = 0)
    ...
    def loadNewsTab(self):
        ...
        self.newsFrame = DirectLabel(relief = None, parent = self.newsDisplay, pos = (0, 0, -0.10000000000000001))
        newspaper.reparentTo(self.newsFrame)
        self.createArticleTextList()
        self.articleImage = None
        self.newsStatusLabel = DirectLabel(text = TTLocalizer.EventsPageNewsDownloading, relief = None, text_scale = 0.10000000000000001, text_wordwrap = 13, parent = self.newsFrame, pos = (0, 0, 0.27500000000000002))
        ...
        self.subLeft = DirectLabel(text = TTLocalizer.EventsPageNewsLeftSubtitle, relief = None, text_scale = 0.050000000000000003, text_align = TextNode.ALeft, parent = self.newsFrame, pos = subLeftPos)
        self.subRight = DirectLabel(text = TTLocalizer.EventsPageNewsRightSubtitle, relief = None, text_scale = 0.050000000000000003, text_align = TextNode.ARight, parent = self.newsFrame, pos = subRightPos)
        if self.UseNewsTab:
    ...
    def getGuestItem(self, name, inviteStatus):
        label = DirectLabel(relief = None, text = name, text_scale = 0.044999999999999998, text_align = TextNode.ALeft, textMayChange = True)
    ...
    def getActivityItem(self, activityBase, count = 1):
        ...
        label = DirectLabel(relief = None, geom = geom, geom_scale = 0.38, geom_pos = Vec3(0.0, 0.0, -0.17000000000000001), text = textForActivity, text_scale = TTLocalizer.EPactivityItemLabel, text_align = TextNode.ACenter, text_pos = (-0.01, -0.42999999999999999), text_wordwrap = 7.0)
        return label
    ...
    def getDecorationItem(self, decorBase, count = 1):
        ...
        label = DirectLabel(relief = None, geom = self.decorationModels.find('**/partyDecoration_%s' % assetName), text = textForDecoration, text_scale = TTLocalizer.EPdecorationItemLabel, text_align = TextNode.ACenter, text_pos = (-0.01, -0.42999999999999999), text_wordwrap = 7.0)
    ...
    def loadInvitations(self):
        ...
        for partyInfo in base.localAvatar.partiesInvitedTo:
            ...
            item = DirectButton(relief = None, text = hostName, text_align = TextNode.ALeft, text_bg = Vec4(0.0, 0.0, 0.0, 0.0), text_scale = 0.044999999999999998, textMayChange = True, command = self.invitePartyClicked)
    ...
    def fillInviteActivityList(self, activityIds):
        ...
        for activityId in countDict:
            ...
            item = DirectLabel(relief = None, text = textOfActivity, text_align = TextNode.ACenter, text_scale = 0.050000000000000003, text_pos = (0.0, -0.14999999999999999), geom_scale = 0.29999999999999999, geom_pos = Vec3(0.0, 0.0, 0.070000000000000007), geom = geom)
    ...
    def createListAndLabel(self, parent, gui, typeString, itemsVisible, downString = 'DownArrow', upString = 'UpArrow', textString = '_text_locator'):
        list = DirectScrolledList(parent = parent, relief = None, incButton_image = (gui.find('**/%s%s_up' % (typeString, downString)), gui.find('**/%s%s_down' % (typeString, downString)), gui.find('**/%s%s_rollover' % (typeString, downString)), gui.find('**/%s%s_inactive' % (typeString, downString))), incButton_relief = None, decButton_image = (gui.find('**/%s%s_up' % (typeString, upString)), gui.find('**/%s%s_down' % (typeString, upString)), gui.find('**/%s%s_rollover' % (typeString, upString)), gui.find('**/%s%s_inactive' % (typeString, upString))), decButton_relief = None, itemFrame_pos = gui.find('**/%s_locator' % typeString).getPos(), itemFrame_relief = None, numItemsVisible = itemsVisible, forceHeight = 0.070000000000000007)
        strings = {
    ...
    def _EventsPage__changePublicPrivate(self, indicator):
        ...
        taskMgr.doMethodLater(5.0, self.changePartyPrivateResponseReceived, 'changePartyPrivateResponseReceivedTimeOut', [
            0,
            0,
    ...
    def createArticleTextList(self):
        ...
        def makeButton(itemName, itemNum, *extraArgs):
            ...
            return DirectLabel(text = itemName, relief = None, text_align = TextNode.ALeft, scale = 0.059999999999999998)
        ...
        self.articleTextList = DirectScrolledList(parent = self.newsFrame, relief = None, pos = topLeftStart, incButton_image = (self.newsFrame.find('**/scrollBtmUp'), self.newsFrame.find('**/scrollBtmDown'), self.newsFrame.find('**/scrollBtmHover'), self.newsFrame.find('**/scrollBtmUp')), incButton_relief = None, incButton_pos = incButtonPos, incButton_image3_color = (1.0, 1.0, 1.0, 0.10000000000000001), decButton_image = (self.newsFrame.find('**/scrollTopUp'), self.newsFrame.find('**/scrollTopDown'), self.newsFrame.find('**/scrollTopHover'), self.newsFrame.find('**/scrollTopUp')), decButton_relief = None, decButton_pos = decButtonPos, decButton_image3_color = (1.0, 1.0, 1.0, 0.10000000000000001), text_scale = 0.050000000000000003, frameSize = (self.articleListXorigin, self.articleListXorigin + self.articleListFrameSizeX, self.articleListZorigin, self.articleListZorigin + self.articleListFrameSizeZ), frameColor = (0.81999999999999995, 0.80000000000000004, 0.75, 1), borderWidth = (0.01, 0.01), numItemsVisible = self.numLinesInTextList, itemMakeFunction = makeButton, forceHeight = itemHeight)
        oldParent = self.articleTextList.decButton.getParent()
        self.newsFrame.find('**/scroll').hide()

    
    def createArticleIndexList(self):
        self.articleIndexList = DirectScrolledList(parent = self.newsFrame, relief = None, pos = (0, 0, 0), incButton_image = (self.newsFrame.find('**/pageRtUp'), self.newsFrame.find('**/pageRtUp'), self.newsFrame.find('**/pageRtHover'), None), incButton_relief = None, incButton_scale = 1, decButton_image = (self.newsFrame.find('**/pageLfUp'), self.newsFrame.find('**/pageLfUp'), self.newsFrame.find('**/pageLfHover'), None), decButton_relief = None, decButton_scale = 1, text_scale = 0.050000000000000003, numItemsVisible = 1)
    ...
    def getRssFeed(self):
        ...
        def addFeedText(unicodeText, textSize = 0.029999999999999999, color = (0, 0, 0, 1), feedText = feedText):
    ...
    def displayArticleImage(self, img):
        ...
        self.articleImage = DirectFrame(parent = self.newsFrame, relief = DirectGuiGlobals.FLAT, image = webTexture, image_scale = (curXSize / 2.0, 1, curYSize / 2.0), pos = center, frameSize = (minX, maxX, minY, maxY))
        foo1 = Point3(0, 0, 0)
        foo2 = Point3(0, 0, 0)
    ...
    def displayArticleText(self, articleText):
        playaLabel = DirectLabel(parent = None, relief = None, text_align = TextNode.ALeft, text = articleText, text_scale = 0.059999999999999998, text_wordwrap = 13.5)
        playaLabel.hide()
    ...
    def createNewsList(self):
        ...
        self.newsList = DirectScrolledList(parent = self.newsFrame, items = self.feedText, relief = None, pos = (-0.5, 0, 0.40000000000000002), incButton_image = (self.scrollButtonGui.find('**/FndsLst_ScrollUp'), self.scrollButtonGui.find('**/FndsLst_ScrollDN'), self.scrollButtonGui.find('**/FndsLst_ScrollUp_Rllvr'), self.scrollButtonGui.find('**/FndsLst_ScrollUp')), incButton_relief = None, incButton_scale = (self.newsArrowButtonScale, self.newsArrowButtonScale, -(self.newsArrowButtonScale)), incButton_pos = (self.newsButtonXstart, 0, self.newsListZorigin - buttonOffSet), incButton_image3_color = Vec4(1, 1, 1, 0.20000000000000001), decButton_image = (self.scrollButtonGui.find('**/FndsLst_ScrollUp'), self.scrollButtonGui.find('**/FndsLst_ScrollDN'), self.scrollButtonGui.find('**/FndsLst_ScrollUp_Rllvr'), self.scrollButtonGui.find('**/FndsLst_ScrollUp')), decButton_relief = None, decButton_scale = (self.newsArrowButtonScale, self.newsArrowButtonScale, self.newsArrowButtonScale), decButton_pos = (self.newsButtonXstart, 0, self.newsListZorigin + self.newsListFrameSizeZ + buttonOffSet), decButton_image3_color = Vec4(1, 1, 1, 0.20000000000000001), itemFrame_pos = (self.newsItemFrameXorigin, 0, 0), itemFrame_scale = 1.0, itemFrame_relief = DirectGuiGlobals.SUNKEN, itemFrame_frameSize = (self.newsListXorigin, self.newsListXorigin + self.newsListFrameSizeX, self.newsListZorigin, self.newsListZorigin + self.newsListFrameSizeZ), itemFrame_frameColor = (0.81999999999999995, 0.80000000000000004, 0.75, 1), itemFrame_borderWidth = (0.01, 0.01), numItemsVisible = 14)
