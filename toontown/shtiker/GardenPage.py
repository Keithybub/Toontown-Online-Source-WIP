...
class GardenPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.basketTab = DirectButton(parent = self, relief = None, text = TTLocalizer.GardenPageBasketTab, text_scale = TTLocalizer.GPbasketTab, text_align = TextNode.ALeft, image = gui.find('**/tabs/polySurface1'), image_pos = (0.55000000000000004, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            GardenPage_Basket], pos = (0.92000000000000004, 0, 0.55000000000000004))
        self.collectionTab = DirectButton(parent = self, relief = None, text = TTLocalizer.GardenPageCollectionTab, text_scale = TTLocalizer.GPcollectionTab, text_align = TextNode.ALeft, image = gui.find('**/tabs/polySurface2'), image_pos = (0.12, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            GardenPage_Collection], pos = (0.92000000000000004, 0, 0.10000000000000001))
        self.trophyTab = DirectButton(parent = self, relief = None, text = TTLocalizer.GardenPageTrophyTab, text_scale = TTLocalizer.GPtrophyTab, text_align = TextNode.ALeft, image = gui.find('**/tabs/polySurface3'), image_pos = (-0.28000000000000003, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            GardenPage_Trophy], pos = (0.92000000000000004, 0, -0.29999999999999999))
        self.specialsTab = DirectButton(parent = self, relief = None, text = TTLocalizer.GardenPageSpecialsTab, text_scale = TTLocalizer.GPspecialsTab, text_align = TextNode.ALeft, image = gui.find('**/tabs/polySurface3'), image_pos = (-0.28000000000000003, 1, -0.91000000000000003), image_hpr = (0, 0, -90), image_scale = (0.033000000000000002, 0.033000000000000002, 0.035000000000000003), image_color = normalColor, image1_color = clickColor, image2_color = rolloverColor, image3_color = diabledColor, text_fg = Vec4(0.20000000000000001, 0.10000000000000001, 0, 1), command = self.setMode, extraArgs = [
            GardenPage_Specials], pos = (0.92000000000000004, 0, -0.29999999999999999))
        ...
        self.gardenSpecialsList = DirectScrolledList(parent = self, relief = None, incButton_image = (gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), incButton_relief = None, incButton_pos = (0.0, 0.0, -1.1000000000000001), incButton_image1_color = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 1.0), incButton_image3_color = Vec4(1.0, 1.0, 0.59999999999999998, 0.5), incButton_scale = (1.0, 1.0, -1.0), decButton_image = (gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), decButton_relief = None, decButton_pos = (0.0, 0.0, 0.11700000000000001), decButton_image1_color = Vec4(1.0, 1.0, 0.59999999999999998, 1.0), decButton_image3_color = Vec4(1.0, 1.0, 0.59999999999999998, 0.59999999999999998), itemFrame_pos = (-0.20000000000000001, 0.0, 0.050000000000000003), itemFrame_relief = None, numItemsVisible = 18, items = [], pos = (-0.59999999999999998, 0, 0.45000000000000001))
        self.gardenSpecialsList.hide()
        self.specialsFrame = DirectFrame(parent = self, relief = None, pos = (0.45000000000000001, 0.0, 0.25), text = '', text_wordwrap = 14.4, text_pos = (0, -0.46000000000000002), text_scale = 0.059999999999999998)
        self.specialsInfo = DirectLabel(parent = self.specialsFrame, relief = None, pos = (0.0, 0.0, -0.0), text = ' ', text_wordwrap = 12.4, text_pos = (0, -0.46000000000000002), text_scale = 0.059999999999999998)
        self.specialsPhoto = SpecialsPhoto.SpecialsPhoto(-1, parent = self.specialsFrame)
        self.specialsPhoto.setBackBounds(-0.29999999999999999, 0.29999999999999999, -0.23499999999999999, 0.25)
        self.specialsPhoto.setBackColor(1.0, 1.0, 0.74900999999999995, 1.0)
        buttons = loader.loadModel('phase_3/models/gui/dialog_box_buttons_gui')
        okImageList = (buttons.find('**/ChtBx_OKBtn_UP'), buttons.find('**/ChtBx_OKBtn_DN'), buttons.find('**/ChtBx_OKBtn_Rllvr'))
        self.useSpecialButton = DirectButton(parent = self, relief = None, image = okImageList, pos = (0.45000000000000001, 0, -0.5), text = TTLocalizer.UseSpecial, text_scale = 0.059999999999999998, text_pos = (0, -0.10000000000000001), command = self._GardenPage__useSpecial)
        buttons.removeNode()
    ...
    def createGardenSpecialsList(self):
        ...
        if len(specialsList) == 0:
            self.gardenSpecialsList['incButton_image1_color'] = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 0.0)
            self.gardenSpecialsList['incButton_image3_color'] = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 0.0)
            self.gardenSpecialsList['decButton_image1_color'] = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 0.0)
            self.gardenSpecialsList['decButton_image3_color'] = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 0.0)
        else:
            self.gardenSpecialsList['incButton_image1_color'] = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 1.0)
            self.gardenSpecialsList['incButton_image3_color'] = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 1.0)
            self.gardenSpecialsList['decButton_image1_color'] = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 1.0)
            self.gardenSpecialsList['decButton_image3_color'] = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 1.0)
            for entry in specialsList:
                if not firstEntry:
                    firstEntry = entry
                
                someItem = DirectScrolledListItem(parent = self.gardenSpecialsList, text = '%s x %s' % (GardenGlobals.Specials[entry[0]]['photoName'], entry[1]), text_align = TextNode.ALeft, text_fg = (0.0, 0.0, 0.0, 1), text_bg = (1.0, 1.0, 1, 0), text_scale = 0.059999999999999998, relief = None, command = self.showSpecialsPanel, extraArgs = [
                    entry])
...
class GardenTrophy(DirectFrame):
    ...
    def _GardenTrophy__bronze(self):
        ...
        self.metalTrophy.setColorScale(0.90000000000000002, 0.59999999999999998, 0.33000000000000002, 1)
    ...
    def _GardenTrophy__silver(self):
        ...
        self.metalTrophy.setColorScale(0.90000000000000002, 0.90000000000000002, 1, 1)
    ...
    def _GardenTrophy__gold(self):
        ...
        self.metalTrophy.setColorScale(1, 0.94999999999999996, 0.10000000000000001, 1)
