...
class PhotoAlbumPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.renameButton = DirectButton(parent = self, relief = None, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (1, 1, 1), pos = (0.45000000000000001, 0, -0.34999999999999998), text = 'Caption', text_scale = 0.059999999999999998, text_pos = (0, -0.02), command = self.renameImage, state = DGG.DISABLED)
        trashcanGui = loader.loadModel('phase_3/models/gui/trashcan_gui')
        self.deleteButton = DirectButton(parent = self, image = (trashcanGui.find('**/TrashCan_CLSD'), trashcanGui.find('**/TrashCan_OPEN'), trashcanGui.find('**/TrashCan_RLVR')), text = ('', 'Delete', 'Delete'), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), text_scale = 0.10000000000000001, text_pos = (0, -0.10000000000000001), text_font = ToontownGlobals.getInterfaceFont(), textMayChange = 0, relief = None, pos = (0.72999999999999998, 0, -0.33000000000000002), scale = 0.40000000000000002, state = DGG.DISABLED, command = self.deleteImage)
        guiButton.removeNode()
        trashcanGui.removeNode()
        gui = loader.loadModel('phase_3.5/models/gui/friendslist_gui')
        self.scrollList = DirectScrolledList(parent = self, relief = None, forceHeight = 0.070000000000000007, pos = (-0.5, 0, 0), incButton_image = (gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), incButton_relief = None, incButton_scale = (1.3, 1.3, -1.3), incButton_pos = (0, 0, -0.51000000000000001), incButton_image3_color = Vec4(1, 1, 1, 0.20000000000000001), decButton_image = (gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), decButton_relief = None, decButton_scale = (1.3, 1.3, 1.3), decButton_pos = (0, 0, 0.51000000000000001), decButton_image3_color = Vec4(1, 1, 1, 0.20000000000000001), itemFrame_pos = (-0.23699999999999999, 0, 0.40999999999999998), itemFrame_scale = 1.0, itemFrame_relief = DGG.SUNKEN, itemFrame_frameSize = (-0.050000000000000003, 0.66000000000000003, -0.88, 0.059999999999999998), itemFrame_frameColor = (0.84999999999999998, 0.94999999999999996, 1, 1), itemFrame_borderWidth = (0.01, 0.01), numItemsVisible = 13, items = [])
        self.renamePanel = DirectFrame(parent = self, relief = None, pos = (0.45000000000000001, 0, -0.45000000000000001), image = DGG.getDefaultDialogGeom(), image_color = ToontownGlobals.GlobalDialogColor, image_scale = (1.0, 1.0, 0.59999999999999998), text = 'Caption Photo', text_scale = 0.059999999999999998, text_pos = (0.0, 0.13), sortOrder = NO_FADE_SORT_INDEX)
        self.renameEntry = DirectEntry(parent = self.renamePanel, relief = DGG.SUNKEN, scale = 0.059999999999999998, pos = (-0.29999999999999999, 0, 0), borderWidth = (0.10000000000000001, 0.10000000000000001), numLines = 1, cursorKeys = 0, frameColor = (0.80000000000000004, 0.80000000000000004, 0.5, 1), frameSize = (-0.20000000000000001, 10, -0.40000000000000002, 1.1000000000000001), command = self.renameDialog)
        ...
        self.deletePanel = DirectFrame(parent = self, relief = None, pos = (0, 0, 0), image = DGG.getDefaultDialogGeom(), image_color = ToontownGlobals.GlobalDialogColor, image_scale = (1.0, 1.0, 0.59999999999999998), text = 'Delete Photo?', text_scale = 0.059999999999999998, text_pos = (0.0, 0.13), sortOrder = NO_FADE_SORT_INDEX)
        ...
        self.leftArrow = DirectButton(parent = self, relief = None, image = (gui.find('**/Horiz_Arrow_UP'), gui.find('**/Horiz_Arrow_DN'), gui.find('**/Horiz_Arrow_Rllvr'), gui.find('**/Horiz_Arrow_UP')), image3_color = Vec4(1, 1, 1, 0.5), scale = (-1.0, 1.0, 1.0), pos = (0.14999999999999999, 0, -0.20999999999999999), command = self.prevPhoto)
        self.rightArrow = DirectButton(parent = self, relief = None, image = (gui.find('**/Horiz_Arrow_UP'), gui.find('**/Horiz_Arrow_DN'), gui.find('**/Horiz_Arrow_Rllvr'), gui.find('**/Horiz_Arrow_UP')), image3_color = Vec4(1, 1, 1, 0.5), pos = (0.75, 0, -0.20999999999999999), command = self.nextPhoto)
        gui.removeNode()
        buttons.removeNode()
