...
class SummonCogDialog(DirectFrame, StateData.StateData):
    ...
    def __init__(self, suitIndex):
        DirectFrame.__init__(self, parent = aspect2dp, pos = (0, 0, 0.29999999999999999), relief = None, image = DGG.getDefaultDialogGeom(), image_scale = (1.6000000000000001, 1, 0.69999999999999996), image_pos = (0, 0, 0.17999999999999999), image_color = ToontownGlobals.GlobalDialogColor, text = TTL.SummonDlgTitle, text_scale = 0.12, text_pos = (0, 0.40000000000000002), borderWidth = (0.01, 0.01), sortOrder = NO_FADE_SORT_INDEX)
