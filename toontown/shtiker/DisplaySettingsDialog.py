...
class DisplaySettingsDialog(DirectFrame, StateData.StateData):
    ...
    def __init__(self):
        DirectFrame.__init__(self, pos = (0, 0, 0.29999999999999999), relief = None, image = DGG.getDefaultDialogGeom(), image_scale = (1.6000000000000001, 1, 1.2), image_pos = (0, 0, -0.050000000000000003), image_color = ToontownGlobals.GlobalDialogColor, text = TTLocalizer.DisplaySettingsTitle, text_scale = 0.12, text_pos = (0, 0.40000000000000002), borderWidth = (0.01, 0.01))
    ...
    def load(self):
        ...
        self.introText = DirectLabel(parent = self, relief = None, scale = TTLocalizer.DSDintroText, text = TTLocalizer.DisplaySettingsIntro, text_wordwrap = TTLocalizer.DSDintroTextWordwrap, text_align = TextNode.ALeft, pos = (-0.72499999999999998, 0, 0.29999999999999999))
        ...
        self.apiMenu = DirectOptionMenu(parent = self, relief = DGG.RAISED, scale = 0.059999999999999998, items = [
            'x'], pos = (0, 0, 0))
        ...
        self.windowedButton = DirectCheckButton(parent = self, relief = None, text = TTLocalizer.DisplaySettingsWindowed, text_align = TextNode.ALeft, text_scale = 0.59999999999999998, scale = 0.10000000000000001, boxImage = innerCircle, boxImageScale = 2.5, boxImageColor = VBase4(0, 0.25, 0.5, 1), boxRelief = None, pos = TTLocalizer.DSDwindowedButtonPos, command = self._DisplaySettingsDialog__doWindowed)
        self.fullscreenButton = DirectCheckButton(parent = self, relief = None, text = TTLocalizer.DisplaySettingsFullscreen, text_align = TextNode.ALeft, text_scale = 0.59999999999999998, scale = 0.10000000000000001, boxImage = innerCircle, boxImageScale = 2.5, boxImageColor = VBase4(0, 0.25, 0.5, 1), boxRelief = None, pos = TTLocalizer.DSDfullscreenButtonPos, command = self._DisplaySettingsDialog__doFullscreen)
        self.embeddedButton = DirectCheckButton(parent = self, relief = None, text = TTLocalizer.DisplaySettingsEmbedded, text_align = TextNode.ALeft, text_scale = 0.59999999999999998, scale = 0.10000000000000001, boxImage = innerCircle, boxImageScale = 2.5, boxImageColor = VBase4(0, 0.25, 0.5, 1), boxRelief = None, pos = TTLocalizer.DSDembeddedButtonPos, command = self._DisplaySettingsDialog__doEmbedded)
        ...
        self.cancel = DirectButton(parent = self, relief = None, text = TTLocalizer.DisplaySettingsCancel, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (0.59999999999999998, 1, 1), text_scale = TTLocalizer.DSDcancel, text_pos = TTLocalizer.DSDcancelPos, pos = (0.20000000000000001, 0, -0.53000000000000003), command = self._DisplaySettingsDialog__cancel)
    ...
    def _DisplaySettingsDialog__apply(self):
        self.cleanupDialogs()
        self.clearBin()
        self.applyDialog = TTDialog.TTDialog(dialogName = 'DisplaySettingsApply', style = TTDialog.TwoChoice, text = TTLocalizer.DisplaySettingsApplyWarning % self.ApplyTimeoutSeconds, text_wordwrap = 15, command = self._DisplaySettingsDialog__applyDone)
    ...
    def _DisplaySettingsDialog__revertBack(self, reason):
        ...
        self.revertDialog = TTDialog.TTDialog(dialogName = 'DisplaySettingsRevert', style = TTDialog.Acknowledge, text = revertText, text_wordwrap = 15, command = self._DisplaySettingsDialog__revertDone)
