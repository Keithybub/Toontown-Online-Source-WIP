...
class InventoryPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.gagFrame = DirectFrame(parent = self, relief = None, pos = (0.10000000000000001, 0, -0.46999999999999997), scale = (0.34999999999999998, 0.34999999999999998, 0.34999999999999998), geom = DGG.getDefaultDialogGeom(), geom_color = ToontownGlobals.GlobalDialogColor)
        self.trackInfo = DirectFrame(parent = self, relief = None, pos = (-0.40000000000000002, 0, -0.46999999999999997), scale = (0.34999999999999998, 0.34999999999999998, 0.34999999999999998), geom = DGG.getDefaultDialogGeom(), geom_scale = (1.3999999999999999, 1, 1), geom_color = ToontownGlobals.GlobalDialogColor, text = '', text_wordwrap = 11, text_align = TextNode.ALeft, text_scale = 0.12, text_pos = (-0.65000000000000002, 0.29999999999999999), text_fg = (0.050000000000000003, 0.14000000000000001, 0.40000000000000002, 1))
        self.trackProgress = DirectWaitBar(parent = self.trackInfo, pos = (0, 0, -0.20000000000000001), relief = DGG.SUNKEN, frameSize = (-0.59999999999999998, 0.59999999999999998, -0.10000000000000001, 0.10000000000000001), borderWidth = (0.025000000000000001, 0.025000000000000001), scale = 1.1000000000000001, frameColor = (0.40000000000000002, 0.59999999999999998, 0.40000000000000002, 1), barColor = (0.90000000000000002, 1, 0.69999999999999996, 1), text = '0/0', text_scale = 0.14999999999999999, text_fg = (0.050000000000000003, 0.14000000000000001, 0.40000000000000002, 1), text_align = TextNode.ACenter, text_pos = (0, -0.22))
