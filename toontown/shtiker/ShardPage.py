...
class ShardPage(ShtikerPage.ShtikerPage):
    ...
    def makeShardButton(self, shardId, shardName, shardPop):
        ...
        shardButtonL = DirectButton(parent = shardButtonParent, relief = None, text = shardName, text_scale = 0.059999999999999998, text_align = TextNode.ALeft, text1_bg = self.textDownColor, text2_bg = self.textRolloverColor, text3_fg = self.textDisabledColor, textMayChange = 0, command = self.getPopChoiceHandler(shardPop), extraArgs = [
            shardId])
        if self.showPop:
            ...
            shardButtonR = DirectButton(parent = shardButtonParent, relief = None, image = button, image_scale = (0.29999999999999999, 1, 0.29999999999999999), image2_scale = (0.34999999999999998, 1, 0.34999999999999998), image_color = self.getPopColor(shardPop), pos = (0.59999999999999998, 0, 0.012500000000000001), text = self.getPopText(shardPop), text_scale = 0.059999999999999998, text_align = TextNode.ACenter, text_pos = (-0.012500000000000001, -0.012500000000000001), text_fg = Vec4(0, 0, 0, 0), text1_fg = Vec4(0, 0, 0, 0), text2_fg = Vec4(0, 0, 0, 1), text3_fg = Vec4(0, 0, 0, 0), command = self.getPopChoiceHandler(shardPop), extraArgs = [
                shardId])
            del model
            del button
